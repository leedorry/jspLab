					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown messages-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								<li class="header">4개의 메시지가 도착했습니다.</li>
								<li>
						...
						<li class="dropdown tasks-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								<li class="header">9개의 과업이 있습니다.</li>
								<li>
									<!-- inner menu: contains the actual data -->
									<ul class="menu">
										<li>
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="dist/img/user3-128x128.jpg" class="user-image"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img
									src="dist/img/user3-128x128.jpg" class="img-circle"
									alt="User Image">

									<p>
										이정현 - 개발자 <small>입사일 2021.4.30</small>
									</p></li>
								<!-- Menu Body -->
								<li class="user-body">
									<div class="row">
								...
								<li class="user-footer">
									<div class="pull-left">
										<a href="./pages/examples/profile.html"
											class="btn btn-default btn-flat">프로필</a>
									</div>
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					<li class="header">주요 내비게이션</li>
					<li class="active treeview"><a href="#"> <i
							class="fa fa-dashboard"></i> <span>대시보드</span> <span
						...
						<ul class="treeview-menu">
							<li class="active"><a href="index.html"><i
									class="fa fa-circle-o"></i> 대시보드 v1</a></li>
							<li><a href="index2.html"><i class="fa fa-circle-o"></i>
									대시보드 v2</a></li>
						</ul></li>
					<li class="treeview"><a href="#"> <i class="fa fa-files-o"></i>
							<span>레이아웃 옵션</span> <span class="pull-right-container"> <span
					...
					<li><a href="pages/widgets.html"> <i class="fa fa-th"></i>
							<span>위젯</span> <span class="pull-right-container"> <small
								class="label pull-right bg-green">new</small>
						</span>
					</a></li>
					<li class="treeview"><a href="#"> <i
							class="fa fa-pie-chart"></i> <span>차트</span> <span
							class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
					...
					<li class="treeview"><a href="#"> <i class="fa fa-laptop"></i>
							<span>UI 요소</span> <span class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
					...
					<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
							<span>유형</span> <span class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
					...
					<li class="treeview"><a href="#"> <i class="fa fa-table"></i>
							<span>테이블</span> <span class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
					...
					<li><a href="pages/calendar.html"> <i
							class="fa fa-calendar"></i> <span>일정</span> <span
					...
					<li><a href="pages/mailbox/mailbox.html"> <i
							class="fa fa-envelope"></i> <span>메일함</span> <span
							class="pull-right-container"> <small
					...
					<li class="treeview"><a href="#"> <i class="fa fa-folder"></i>
						...
						<ul class="treeview-menu">
							<li><a href="pages/examples/generalBoard.html"><i
									class="fa fa-circle-o"></i> 일반 게시판</a></li>
							<li><a href="pages/examples/dongaBoard.html"><i
				...
				<div id="visual">
					<div id="mySwipe" class='swipe'>
						<ul class="touch_banner swipe-wrap">
							<!-- 배너 목록 -->
							<li><a href="#"><img src="dist/img/visual_img_1.jpg"
									alt="" /></a></li>
							<li><a href="#"><img src="dist/img/visual_img_2.jpg"
									alt="" /></a></li>
							<li><a href="#"><img src="dist/img/visual_img_3.jpg"
									alt="" /></a></li>
						</ul>
					</div>
					<ul class="touch_bullet">
						<!-- 배너 위치 표시 -->
						<li><img src="dist/img/visual_bullet_on.png" class="active"
							alt="" /></li>
						<li><img src="dist/img/visual_bullet_off.png" alt="" /></li>
						<li><img src="dist/img/visual_bullet_off.png" alt="" /></li>
					</ul>
					<p class="touch_left_btn">
						<!-- 이전 버튼 -->
						<a href="#"> <img src="dist/img/visual_btn_left.png" alt="이전 배너" />
						</a>
					</p>
					<p class="touch_right_btn">
						<!-- 다음 버튼 -->
						<a href="#"> <img src="dist/img/visual_btn_right.png"
							alt="다음 배너" />
						</a>
					</p>
				</div>
