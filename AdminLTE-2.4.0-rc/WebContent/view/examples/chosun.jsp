...
#news_wrap {
	width: 380px;
	margin: 0 auto;
	background: #FFF url("images/rss_bg.gif") 0 19px repeat-x;
}
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			조선닷컴 <small>it all starts here</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="#">Examples</a></li>
			<li class="active">조선닷컴</li>
		</ol>
	</section>
		...
		<div class="box">
			...
			<div class="box-body">
				...
				<div id="news_wrap">
					...
					<h2>
						<a href="https://it.donga.com/feeds/rss/news/">동아뉴스</a>
					</h2>
					<ul id="news_list">
					</ul>
				</div>
