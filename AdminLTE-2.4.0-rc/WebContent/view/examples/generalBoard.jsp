...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/view/main/css/DataTables/jquery.dataTables.min.css">
<link rel="stylesheet" type="text/css"
...
<script type="text/javascript" language="javascript"
	src="<%= request.getContextPath() %>/view/main/js/DataTables/jquery.dataTables.min.js"></script>
