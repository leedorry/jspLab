					...
					<div class="tab-content">
						<div class="tab-pane" id="activity">
							...
							<div class="post">
								<div class="user-block">
									<img class="img-circle img-bordered-sm"
										src="<%=request.getContextPath()%>/resources/dist/img/user6-128x128.jpg"
										alt="User Image"> <span class="username"> <a
								...
								<div class="row margin-bottom">
									<div class="col-sm-6">
										<img class="img-responsive"
											src="<%=request.getContextPath()%>/resources/dist/img/photo1.png"
											alt="Photo">
									</div>
									<!-- /.col -->
									<div class="col-sm-6">
										<div class="row">
											<div class="col-sm-6">
												<img class="img-responsive"
													src="<%=request.getContextPath()%>/resources/dist/img/photo2.png"
													alt="Photo"> <br> <img class="img-responsive"
													src="<%=request.getContextPath()%>/resources/dist/img/photo3.jpg"
													alt="Photo">
											</div>
											<!-- /.col -->
											<div class="col-sm-6">
												<img class="img-responsive"
													src="<%=request.getContextPath()%>/resources/dist/img/photo4.jpg"
													alt="Photo"> <br> <img class="img-responsive"
													src="<%=request.getContextPath()%>/resources/dist/img/photo1.png"
													alt="Photo">
											</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="name"
											placeholder="이름" value="${authUser.name}">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="email" class="form-control" id="eamil"
											placeholder="이메일" value="${authUser.id}">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="password" class="form-control" id="password"
											placeholder="현재 암호" name="curPwd">
										<c:if test="${errors.curPwd}">현재 암호를 입력하세요.</c:if>
										<c:if test="${errors.badCurPwd}">현재 암호가 일치하지 않습니다.</c:if>
									</div>
								</div>
								<div class="form-group">
									<label for="inputExperience" class="col-sm-2 control-label">새
										암호</label>

									<div class="col-sm-10">
										<input type="password" class="form-control" id="newpassword"
											placeholder="새 암호" name="newPwd">
